"""
Phase C-2: Optimized Block-Sparse GPU Kernels

This module provides CUDA kernels optimized for Phase C-2:
...
from smatrix_2d.phase_c.dual_block_mask import DualBlockMask
from smatrix_2d.phase_c.block_sparse import BlockSparseConfig


# ============================================================================
# CUDA Kernel: GPU Block Mask Update (Parallel Reduction)
# ============================================================================
...
# ============================================================================
# CUDA Kernel: Spatial Streaming with Dual Block Masks
# ============================================================================
...
# ============================================================================
# Phase C-2 Transport Step
# ============================================================================

class BlockSparseGPUTransportStepC2:
    """Phase C-2: Optimized block-sparse transport step with dual masks.

    Key improvements over Phase C-1:
    1. Dual block masks (input/output) for conservation
    2. GPU-based block mask update
    3. Proper halo management
    ...
    def __init__(
        ...
        """Initialize Phase C-2 block-sparse transport step.
        ...
        if not GPU_AVAILABLE:
            raise RuntimeError("CuPy required for BlockSparseGPUTransportStepC2")
    ...
    def _compile_kernels(self):
        """Compile Phase C-2 CUDA kernels."""
    ...
    def apply(
        ...
        """Apply complete transport step with Phase C-2 optimization.
